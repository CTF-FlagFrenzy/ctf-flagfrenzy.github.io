...
The CTF FlagFrenzy backend provides the API Endpoints that power the platform. 
...
## Authentication 
The Authentication is made with Azure. For this purpose, a separate app was created in Azure and Svelte contacts this and registers the user with Azure.
![alt text](../../../../assets/backend/Azure.png)

## Database
The Database saves all necessary information to run the CTF. 

In the following figure you can see the ER-Diagram of the Database.
