---
title: CTF Steganograpy-Challenge | Gits Secret: Layers of Discovery
...
When having the account and repository one only has to run some git commands to solve the challenge.
