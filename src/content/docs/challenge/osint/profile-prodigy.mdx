---
title: CTF OSINT-Challenge | Profile Prodigy: 
...
As soon as the account is finished, the posts can be uploaded and with it the flags will be created. Also designing the profile is important.
